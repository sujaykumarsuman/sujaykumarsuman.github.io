    ...
    <section id="contact" className="section contact" data-section="contact">
      ...
      <div className="contact-card">
        ...
        <div className="contact-email-row">
          <a href={`mailto:${data.meta.email}`} className="contact-email">{data.meta.email}</a>
          <button className="copy-btn" onClick={copyEmail} aria-label={copied ? 'Copied' : 'Copy email'} title={copied ? 'Copied' : 'Copy email'}>
          ...
          <a className="mail-btn" href={`mailto:${data.meta.email}`} aria-label="Send email" title="Send email">
